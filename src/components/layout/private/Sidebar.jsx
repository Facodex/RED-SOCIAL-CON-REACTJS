...
export const Sidebar = () => {
    ...
    // metodo para publicar publicacion 
        ...
        <aside className="layout__aside">
            ...
            <div className="aside__container">
                ...
                <div className="aside__container-form">
                    ...
                    {stored == 'stored' ? <strong className='messages_edit_user alert alert-success'>Publicada correctamente </strong> : ''}
                    {stored == 'error' ? <strong className='messages_edit_user alert alert-danger'>Error en la publicacion</strong> : ''}
